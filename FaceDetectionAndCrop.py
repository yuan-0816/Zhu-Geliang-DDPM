        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    label_ = f'{names[int(cls)]} {conf:.2f}'
                    if 'head' in label_ and heads: 
                        ...
                        # 生成圖像保存路徑
                        crop_save_path = save_dir / f'{p.stem}_frame_{frame}_head_{head_idx}.jpg'
                        # 保存裁剪後的圖像
                        ...
                        print(f'\nname:{p.stem}, frame:{frame}, head_idx:{head_idx}') 
                        head_idx += 1
